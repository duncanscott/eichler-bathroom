...
- Present compact and elongated enclosures as consecutive layout subsections, each beginning with a heading, short description and sketch. Do not restore the separate “Compact-cover option” proposal card beside the fan specifications. Keep shared grille links after both layouts. The elongated soffit is a visible comparison option with its own sketch. Its preliminary dimensions are qualified as estimates, and the optional second grille is described without assuming active cavity ventilation. All part links remain accessible.
...
- The `#broan` section covers L100E dimensions, HVI vertical-discharge performance, its 8-inch upward outlet, on/off operation and a custom rooftop enclosure concept. Keep the Broan row last in the opening table and the Broan section after the other layout sections. The final section is `#contractor`, titled “Questions for comparing the layouts.” Flag the Title 24 entry in both places without marking L100E as excluded. Broan’s Title 24 listing is “No”; it is ENERGY STAR certified and its specification sheet carries HVI-2100 certified ratings that meet §7.1, §7.3.2 and §5.2 of the 2025 CEC form. Present the entry as unexplained rather than disqualifying, keep the request for a written explanation from Broan, and do not imply that a humidity control alone resolves it. Preserve that distinction and the difference between the documented outlet conversion and the unverified custom enclosure detail.
...
- Historical certification and AMCA sound data are not presented as current certification or HVI bathroom sound ratings. For the REC54, the certified-rating question under §7.1 is presented ahead of ENERGY STAR status, and the §7.3 remote-fan exception is described as waiving sound ratings only. The PBW110 appears as a bath-listed fallback, not as a fifth layout.
