...
- The `#broan` section covers L100E dimensions, HVI vertical-discharge performance, its 8-inch upward outlet, on/off operation and a custom rooftop enclosure concept. Keep the Broan row last in the opening table and the Broan section last in the document. Flag the Title 24 entry in both places without marking L100E as excluded. Broan’s Title 24 listing is “No”; it is ENERGY STAR certified and its specification sheet carries HVI-2100 certified ratings that meet §7.1, §7.3.2 and §5.2 of the 2025 CEC form. Present the entry as unexplained rather than disqualifying, keep the request for a written explanation from Broan, and do not imply that a humidity control alone resolves it. Preserve that distinction and the difference between the documented outlet conversion and the unverified custom enclosure detail.
